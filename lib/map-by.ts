export function mapBy<Fn extends (el: any) => any>(
	fn: Fn
): (
	list: readonly Parameters<Fn>[0][]
) => Map<ReturnType<Fn>, Parameters<Fn>[0]>
export function mapBy<Fn extends (el: any) => any>(
	fn: Fn,
	list: readonly Parameters<Fn>[0][]
): Map<ReturnType<Fn>, Parameters<Fn>[0]>
 ...
 */
export function mapBy(fn: (el: any) => any, list?: readonly any[]): any {
	if (list === undefined) {
		return (list: readonly any[]) => mapBy(fn, list)
	} else {
